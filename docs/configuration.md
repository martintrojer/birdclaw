...
| `BIRDCLAW_OPENAI_BASE_URL`     | Point at an OpenAI-compatible server (e.g. Ollama `http://localhost:11434/v1`); default `https://api.openai.com/v1`. Ambient `OPENAI_BASE_URL` is deliberately ignored |
